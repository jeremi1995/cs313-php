...
<body>
    ...
    <header class="navbar navbar-expand-sm bg-light navbar-light">
        <div class="container">
            ...
            <ul class="navbar-nav nav-tabs">
                <li class="nav-item">
                    <a class="nav-link active" href="assign03-tshirts.php">T-shirt</a>
                </li>
                <li class="nav-item">
    ...
    <div class="container items-display">
        <br><br>
        T-shirts
        <div class="row mx-auto">
            <div class="item-container col-md-3 mx-2 my-2">
                <img class="item" src="../resource/assign03/tshirt/tshirt1.jpg" alt="">
                <form action="cart.php" method="POST">
                    Red Ivanti Shirt - $9:99<br>
                    <input type="hidden" value="ts1" name="itemToCart">
                    <button type="submit" class="btn btn-primary btn-sm">Add to cart</button>
                </form>
            </div>
            <div class="item-container col-md-3 mx-2 my-2">
                <img class="item" src="../resource/assign03/tshirt/tshirt2.jpg" alt="">
                <form action="cart.php" method="POST">
                    Blue Lucid Shirt - $9:99<br>
                    <input type="hidden" value="ts2" name="itemToCart">
                    <button type="submit" class="btn btn-primary btn-sm">Add to cart</button>
                </form>
            </div>
            <div class="item-container col-md-3 mx-2 my-2">
                <img class="item" src="../resource/assign03/tshirt/tshirt3.jpg" alt="">
                <form action="cart.php" method="POST">
                    Grey 39 Shirt - $9:99<br>
                    <input type="hidden" value="ts3" name="itemToCart">
                    <button type="submit" class="btn btn-primary btn-sm">Add to cart</button>
                </form>
            </div>
            <div class="item-container col-md-3 mx-2 my-2">
                <img class="item" src="../resource/assign03/tshirt/tshirt4.jpg" alt="">
                <form action="cart.php" method="POST">
                    Grey Shirt - $9:99<br>
                    <input type="hidden" value="ts4" name="itemToCart">
                    <button type="submit" class="btn btn-primary btn-sm">Add to cart</button>
                </form>
            </div>
        </div>
